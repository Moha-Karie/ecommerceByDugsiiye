...
const CartItems = () => {
  ...
  const { products, removeFromCart, updateProductQuantity } =
    useShopContextHook();
  ...
  return (
    <div className="flex flex-col lg:flex-row p-4 lg:p-8 space-y-6 lg:space-x-6">
      {/* Cart Items */}
      <div className="flex-1">
        <h2 className="text-2xl font-semibold mb-4">
          {products.length > 0
            ? "Your Cart Items"
            : "Your cart is empty right now please go a head and ad some items"}
        </h2>
              ...
              <div className="flex items-center justify-between mt-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      className="border border-gray-200 w-16 text-center rounded-md p-2"
                      type="number"
                      name="quantity"
                      min={1}
